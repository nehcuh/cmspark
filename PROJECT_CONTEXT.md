...
- **Anthropic P1** (local / branch):
  ...
  - extra_headers 广播脱敏
- **测试**: companion llm-connection + headers + anthropic + model-probe 69 pass；extension sidepanel-state 15 pass
- **下次**: 合 P1 PR；真机 Coding Plan 中继 smoke（可选）；S36 residual unattended honesty
