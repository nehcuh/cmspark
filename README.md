...
make package-macos
# 产出：
#   dist-package/CMspark-v0.5.8-macOS.dmg   ← 安装包
#   dist-package/cmspark-v0.5.8-macos-arm64.zip  ← 原始压缩包
```
