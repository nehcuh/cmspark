...
> 产品 **0.5.6** · 入口 README：[仓库根 README.md](../README.md)  
...
| [GOAL.md](GOAL.md) | 项目目标与阶段（与 **0.5.6** 对齐；扩展目标带轴标注） |
...
- 事实以 **0.5.6 代码**（`companion`/`chrome-extension` `package.json`）与 live ADR 为准；过程稿冲突时以 ADR / architecture / 用户指南为准。  
