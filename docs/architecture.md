...
> 版本: 2.4.6 | 日期: 2026-09-01 | 状态: 已确认（同步 **0.5.7** + **[ADR-020](adr/020-capability-model-three-axes.md) 能力三轴** · 当轮活计划 · ADR-023/024 语音（含 2026-08-31 L13 非静默回退）· Capture HTML 卡 360×420 流式 · 用户附图 · Windows NSIS · 知识诚实 · ChatShell；T1 **已记分、禁扩 profile**）
