...
/**
 * Overlay HTML v2 privacy sheet — lockstep with
 * chrome-extension/src/sidepanel/voice/privacy-copy.ts VOICE_PRIVACY_ACK_V2_CLAUSES.
 * Swift HUD still uses SUMMONER_MIC_SIDEBAR; do not rename that constant.
 */
