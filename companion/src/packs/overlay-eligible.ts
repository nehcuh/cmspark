...
const DANGEROUS_TOOL =
  /^(navigate|evaluate|osascript_eval|spawn_worker|spawn_expert_team|propose_expert_team|create_tab|screenshot|get_page_|list_tabs|click|dblclick|type|fill_form|host_|computer|shell_exec|netsec_|acp_|workspace_)/i
